export const getRecommendeTripUrl = (router) => {
  ...
  tags = tags.split(",");
  return `${process.env.NEXT_PUBLIC_baseURL}/recommended-trips/?cultural=${
    tags.includes("cultural") ? "true" : ""
  }&weekend_getaway=${tags.includes("weekend_getaway") ? "true" : ""}&family=${
    tags.includes("family") ? "true" : ""
  }&romantic=${tags.includes("romantic") ? "true" : ""}&road_trip=${
    tags.includes("road_trip") ? "true" : ""
  }&day_game_drives=${
