...
function EventKaleidoscope({ lodges }) {
  return (
    <div>
      <div className="px-0 md:px-8 md:mt-4 rounded-tl-3xl rounded-tr-md rounded-br-3xl rounded-bl-md">
        <Header></Header>
      </div>
          ...
          >
            {lodges.map((lodge, index) => {
              ...
              const getFullBoardPackageImage = () => {
                const sortedImages = lodge.private_safari
                  ? lodge.private_safari.private_safari_images.sort(
                      (x, y) => y.main - x.main
                    )
                  : [];
              ...
              const getGamePackageImages = () => {
                const sortedImages = lodge.shared_safari
                  ? lodge.shared_safari.shared_safari_images.sort(
                      (x, y) => y.main - x.main
                    )
                  : [];
              ...
              const getAllInclusiveImages = () => {
                const sortedImages = lodge.all_inclusive
                  ? lodge.all_inclusive.all_inclusive_images.sort(
                      (x, y) => y.main - x.main
                    )
                  : [];
              ...
              const getOtherOptionImages = () => {
                ...
                lodge.other_options.forEach((option) => {
              ...
              return (
                <SwiperSlide key={index} className="!w-[325px]">
                  <Card
                    ...
                    subCarouselClassName="hidden !p-0"
