  ...
  return (
    <div className="relative">
      ...
      <div className="flex gap-4 px-4">
        <div className="w-[30%] bg-green-400 h-[90vh] mt-0 sticky top-[80px]"></div>
        <div className="w-[70%]">
          <div className="h-16 bg-gray-50 absolute right-0 w-[69%] flex px-3">
            <div className="w-[40%] pl-3 flex items-center border-r">
              <div className="text-sm text-gray-800 font-OpenSans flex gap-0.5 items-center">
                <div className="mr-0.5 font-bold">
                  <Price
                    className="!text-2xl !font-OpenSans"
            ...
            <div className="w-[25%] flex items-center pl-3 border-r">
              <h1 className="font-bold text-gray-800 text-2xl font-OpenSans">
                3 days
              </h1>
            </div>

            <div className="w-[35%] flex items-center pl-3">
          ...
          <div className="flex gap-6 items-center mt-6">
            <div>
              <Icon icon="fa6-solid:car" className="w-10 h-10 text-gray-500" />
            </div>
            <div className="flex flex-col">
              <h1 className="mb-1 font-bold text-gray-700 font-OpenSans text-2xl">
                Transport
