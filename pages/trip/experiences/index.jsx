...
import ActivityTrip from "../../../components/Trip/ActivityTrip";

const ExperiencesTrips = ({ userProfile }) => {
  const [state, setState] = useState({});

  const [showDropdown, changeShowDropdown] = useState(false);

  const [currentNavState, setCurrentNavState] = useState(2);
        ...
        <div className="flex justify-between relative h-full w-full">
          ...
          >
            ...
            >
              ...
              <div
                className={
                  "absolute hidden md:flex cursor-pointer select-none items-center justify-center top-[20%] z-50 left-0 -translate-y-2/4 swiper-pagination swiper-button-prev " +
              ...
              <div
                className={
                  "absolute hidden cursor-pointer md:flex select-none items-center justify-center top-[20%] z-50 right-0 -translate-y-2/4 swiper-pagination swiper-button-next " +
          ...
          <div className="relative right-0 h-full xsMax:w-full px-4 w-full md:w-[63%]">
            <ActivityTrip
              userProfile={userProfile}
              trips={trips}
            ></ActivityTrip>
...
export default ExperiencesTrips;
