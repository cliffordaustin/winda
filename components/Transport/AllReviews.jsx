...
const AllReviews = ({
    ...
    if (page <= Math.ceil(reviewCount / reviewPageSize)) {
      try {
        const res = await axios.get(
          `${process.env.NEXT_PUBLIC_baseURL}/transport/${router.query.slug}/reviews/?page=${page}`
        );
  ...
  const loadMoreFilteredReviewData = async (page) => {
    if (page <= Math.ceil(reviewCount / reviewPageSize)) {
      try {
        const res = await axios.get(
          `${process.env.NEXT_PUBLIC_baseURL}/transport/${router.query.slug}/reviews/?page=${page}&rate=${filterRateVal}`
        );
