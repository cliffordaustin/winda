  ...
  return (
    <div>
      ...
      <div className="flex lg:bg-gray-100 gap-2 mt-[20px] lg:mt-[110px] relative">
            ...
            <div className="flex gap-4 items-center px-8 lg:px-4 border-t fixed bottom-0 right-0 w-full lg:w-[55.3%] xl:w-[45%] bg-white h-[40px]">
              ...
              >
                ...
                <p className="mt-2">
                  ...
                  There will be a cash bar serving drinks for the duration of
                  the event at Kilima Camp. Accommodation at Kilima camp is also
                  full board and there will be food to purchase for those not
                  staying at Kilima.{" "}
                </p>
                ...
                <h1 className="font-bold mt-4">
                  Is there transportation from Nairobi to the accommodation
                  around Amboseli?
                </h1>
                ...
                <p className="mt-2">
                  ...
                  dress accordingly. Also, we recommend you wear suitable
                  footwear as they ground might be uneven.{" "}
                </p>
              ...
              >
                ...
                <p className="mb-2">
                  There will be two pickups within Nairobi:
                </p>
                <div className="ml-4">
                ...
                <p className="mt-2">
                  ...
                  shared with the transfer company and they will communicate
                  with you directly.
                </p>
                <h1 className="font-bold mt-4 underline">Event Transfers</h1>
                <p className="mt-4">
                  We have organized transfers between Kibo Camp and Kilima
                  Safari Camp for KES 2,000 per person for the weekend. This
                  will include <span className="font-bold">transfers</span> to
                  and from your accommodation (if not staying at Kilima Safari
                  Camp) and the event location (Kilima Safari Camp). This will
                  be paid at the event.
                </p>
                <p className="mt-2 font-bold">
                  Transfer times will be confirmed closer to the time of the
                  event
                </p>
                ...
                <p className="mt-2">
                  Please note that all damages inflicted on the accommodation
                  are the responsibility of the clients to settle with said
                  accommodation.
                </p>
                ...
                <p className="mt-2">
                  Please be sensible and appreciate it will get cold in the
                  night and possibly very warm in the day. Rain is also a
                  possibility, dress accordingly. We also highly recommend
                  adequate supportive footwear as the ground may be uneven.
                </p>
                <p className="mt-4">Cancellation Policy</p>
                <p className="mt-2">
                  There will be no refunds for any accommodation booked and no
                  transfer of names associated with bookings. All sales are
                  final.
                </p>
        ...
        {stays.length === 0 && (
          <div
            className="w-full relative mb-10 sm:w-[80%] flex flex-col items-center justify-center gap-2 sm:mx-auto lg:w-[55%] xl:w-[45%] px-4
          py-3 h-full"
          >
            <span className="text-xl font-bold mt-6">
              All rooms and transportation are fully booked
            </span>
          </div>
        )}
      </div>
